...
struct Constants {
    ...
    struct Fonts {
        static let defaultFont = font(18)
    ...
    struct Sizes {
        ...
        static let navBarH: CGFloat = Bools.specialScreen ? 88.0 : 64.0
        static let tabBarH: CGFloat = Bools.specialScreen ? 83.0 : 49.0
        static let statusBarH: CGFloat = Bools.specialScreen ? 44.0 : 20.0
